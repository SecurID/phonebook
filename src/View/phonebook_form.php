...
<form action="/search" method="get" class="bg-white shadow-md rounded px-8 pt-6 pb-8 w-full max-w-sm">
    <div class="mb-4">
        ...
        <input type="number" id="search" name="search" placeholder="567" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    </div>
    <div class="flex items-center justify-between">
